...
const LoginScreen = () => {
    ...
    return (
        <View style={styles.container}>
            <Image source={require('../shein/assets/logo.png')} style={styles.logo} />
            ...
            <View style={styles.socialLoginContainer}>
                <TouchableOpacity style={styles.socialButton} onPress={handleGoogleLogin}>
                    <View style={styles.socialButtonContent}>
                        <Image source={require('../shein/assets/logoGoogle.png')} style={styles.socialIcon} />
                ...
                <TouchableOpacity style={styles.socialButton} onPress={handleFacebookLogin}>
                    <View style={styles.socialButtonContent}>
                        <Image source={require('../shein/assets/logoFacebook.png')} style={styles.socialIcon} />
            ...
            <TouchableOpacity style={styles.countryButton}>
                <View style={styles.countryButtonContent}>
                    <Image source={require('../shein/assets/locationIcon.png')} style={styles.countryIcon} />
                    <Text style={styles.countryButtonText}>Brasil </Text>
                    <Image source={require('../shein/assets/setaBaixo.png')} style={styles.countryIcon} />
                </View>
            </TouchableOpacity>
        </View>
    );
